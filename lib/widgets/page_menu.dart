...
class _PageMenuState extends State<PageMenu> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<DataBloc, DataState>(
        builder: (context, state) => LayoutBuilder(builder:
                (BuildContext contextText, BoxConstraints constraints) {
              var planetFlex = 2;
              var boxLevelFlex = 8;
              var boxPlanetFlex = 3;
                  ...
                  Positioned(
                    ...
                    child: Container(
                        margin: EdgeInsets.only(
                            top: planetDim / 2, left: 20, right: 20),
                        ...
                        child: Container(
                            ...
                            child: infinityMode
                                ? HexagonButton(
                                    ...
                                    block: Block.build(
                                        0, true, BlockColor.color_1, true),
                                    text: "Play",
                                    currentTheme: widget.currentTheme)
                                : gridMenu())),
                  ),
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(
                                  widget.currentTheme.background_path),
                              fit: BoxFit.cover,
                            ),
                            boxShadow: [
                              BoxShadow(
